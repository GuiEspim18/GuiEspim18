...
## 💪🏻 Skills
[![My Skills](https://skillicons.dev/icons?i=javascript,typescript,nodejs,php,java,python,regex,cpp,postgresql,mysql,mongodb,sqlite,arduino,nestjs,angular,express,react,vite,html,css,scss,materialui,bootstrap,styledcomponents,figma,git&theme=dark)](https://skillicons.dev)
